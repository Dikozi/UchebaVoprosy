...
**Актуальная версия — «Режим» (v2):** папка [`rezhim/`](rezhim/README.md), файлы `Режим · … .xlsx`
в этой папке. Продукт собран под Google Таблицы и телефон по спецификации совета
([`council/итог_v2.md`](council/итог_v2.md)).

Ниже — описание первой версии (v1) для Excel, она осталась в репозитории как отправная точка.

---

# Планер привычек v1 — Excel-трекер на год
